...
class LevitationUnicalItem @Inject constructor(
    ...
    override fun getType(): UnicalItemType = UnicalItemType.LEVITATION
            ...
            world.getNearbyEntities(center, radius, radius, radius)
                ...
                .forEach { player ->
                    player.addPotionEffect(
                        PotionEffect(PotionEffectType.LEVITATION, 20 * 5, 0)
                    )
                }
