package ru.lewis.items.extension
...
import ru.lewis.items.model.ExtendedAudience
import java.util.*
...
fun Player.playNo() {
    this.playSound(this.location, Sound.ENTITY_VILLAGER_NO, 1.0f, 1.0f)
}

fun Player.playYes() {
    this.playSound(this.location, Sound.ENTITY_VILLAGER_YES, 1.0f, 1.0f)
}
